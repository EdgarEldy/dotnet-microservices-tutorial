...
/// claim is identity-api's integer user id, which order-api stores as Order.UserId.
/// </summary>
public static class TestTokens
{
    /// <summary>The key given to the service as Jwt:SigningKey (AppHost injects the real one).</summary>
    public const string SigningKey = "order-api-tests-signing-key-at-least-256-bits-long";
