...
/// and therefore without the injected "identity-db" connection string. Adding a migration does
...
public sealed class DesignTimeAppDbContextFactory : IDesignTimeDbContextFactory<AppDbContext>
{
    private const string DesignTimeConnectionString =
        "Host=design-time-placeholder;Database=identity-db;Username=postgres;Password=design-time-only";
