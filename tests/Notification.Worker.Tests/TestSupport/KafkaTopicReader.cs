...
/// <summary>
/// Reads Kafka topics from the beginning with a throwaway consumer group (copied from
/// Identity.API.Tests), and parses the event bodies. Every read is bounded by a timeout.
/// </summary>
    ...
    public static Task<KafkaReadResult> ReadUntilAsync(
        ...
        Task.Run(() =>
        {
            var config = new ConsumerConfig
            {
                ...
                GroupId = $"notification-worker-tests-{Guid.NewGuid():N}",
